...
import { Compass, Filter, ArrowRight, Scale, BookOpen, Layers, Globe, ExternalLink, Building2 } from 'lucide-react';
          ...
          >
            <div className="space-y-4">
              ...
              <div className="space-y-2 pt-3 border-t border-slate-100 dark:border-slate-700 text-xs text-slate-600 dark:text-slate-300">
                ...
                {ex.officialWebsite && (
                  <div className="flex items-center justify-between p-2 rounded-lg bg-emerald-50/70 dark:bg-emerald-950/40 border border-emerald-200/70 dark:border-emerald-800/60">
                    <div className="flex items-center gap-1.5 min-w-0 pr-2">
                      <Globe className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 shrink-0" />
                      <div className="min-w-0">
                        <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400 block leading-none mb-0.5">Govt Official Website</span>
                        <span className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate block">
                          {ex.officialWebsiteName || ex.conductingBody}
                        </span>
                      </div>
                    </div>
                    <a
                      ...
                      className="px-2 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-[11px] font-bold shrink-0 transition flex items-center gap-1 shadow-xs"
                      title={`Visit ${ex.officialWebsiteName || 'Govt Official Portal'}`}
